...
/*! \file HubbardOneOrbitalObsStored.h
 *
 *  HubbardOneOrbitalObsStored for pnictidesTwoOrbitals model
 *
 */

#ifndef OBS_STORED_HUBBARD_ONE_ORBITAL_H
#define OBS_STORED_HUBBARD_ONE_ORBITAL_H
#include "Vector.h"

namespace Spf {
	template<typename SpinOperationsType,typename ComplexType,
	typename ParametersModelType,typename ConcurrencyType>
	class HubbardOneOrbitalObsStored {
...
/*@}*/
#endif // OBS_STORED_HUBBARD_ONE_ORBITAL_H
