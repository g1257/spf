...
print "Available: MODEL_KONDO_INF_ONEBAND, MODEL_KONDO_INF_ONEBAND_PHONONS, MODEL_KONDO_INF_TWOBANDS MODEL_KONDO_INF_TWOBANDS_NOPHONONS MODEL_KONDO_FINITE ";
print " MODEL_KONDO_DMS_ZINCBLENDE or MODEL_KONDO_DMS_CUBIC or MODEL_KONDO_DMS_THREEBANDS or ";
print " MODEL_KONDO_BCS or MODEL_KONDO_DMS_FCC or MODEL_KONDO_PNICTIDES\n";
...
} elsif ($model eq "MODEL_KONDO_INF_TWOBANDS_NOPHONONS") {
	$exename="spf2b_np";
	$modelcpp="kondo_inf_twobands_nophonons";
...
} elsif ($model eq "MODEL_KONDO_PNICTIDES") {
	$exename = "spfpnictides";
	$modelcpp="kondo_pnictides";
} else {
